...
public class RemoteDataAdapter implements IDataAccess {
    ...
    public boolean saveCustomer(CustomerModel customer) {
    	  ...
    	  String json = netSend(MessageModel.PUT_CUSTOMER, gson.toJson(customer));
          MessageModel message = gson.fromJson(json, MessageModel.class);
	...
	public PurchaseModel loadPurchase(int mPurchaseID) {
		String json = netSend(MessageModel.GET_PURCHASE, Integer.toString(mPurchaseID));
        MessageModel message = gson.fromJson(json, MessageModel.class);
	...
	public boolean savePurchase(PurchaseModel purchase) {
		  String json = netSend(MessageModel.PUT_PURCHASE, gson.toJson(purchase));
          MessageModel message = gson.fromJson(json, MessageModel.class);
          if (message.code == IDataAccess.PURCHASE_SAVE_OK)
              return true;
          else
              return false;
	}
